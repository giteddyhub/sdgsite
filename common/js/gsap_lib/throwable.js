! function($) {
    ...
    class i {
        ...
        createWorld() {
            ...
            // Remove mouse and mouseConstraint for no interactivity
            ...
            //     }
            // });
            this.engine.gravity.y = 0.3; // Lower gravity for smoother drop
            // Matter.Composite.add(this.engine.world, [this.mouseConstraint]);
            Matter.Runner.start(this.runner, this.engine);
            // Remove pointer events for mouseConstraint
        ...
        startRain() {
            this.bodies.forEach(((t, e) => {
                ...
                }), 140 * e) // Increase interval for smoother stagger
            }));
            let t = !1;
            Matter.Events.on(this.runner, "tick", (() => {
